The overall objective of this 'to do' list is to come up with a Problem Statement that aligns with the company's objective
...
1. - [ ] Pytorch
        a. - [ ] torch.nn
        b. - [ ] RNN, LSTM and Transformers - With and Without Pytorch implementation

2. - [ ] LINUX
        a. - [ ] Linux File management system and basically all file and there structure (what is where and how they work).
        b. - [ ] Linux Process Management - kernel processes (systemd), services and Processes and how they are managed internally.(IMP)
        c. - [ ] Linux Networking - TCP, UDP, curl, IPs, encryption -> verbosity of all and how they work, get fluent with them.
